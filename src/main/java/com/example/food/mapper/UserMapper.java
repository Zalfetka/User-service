...
public abstract class UserMapper {
    ...
    public abstract void updateUserFromRequest(UserUpdateRequest request, @MappingTarget UserEntity user);

    @AfterMapping
    protected void validateAge(UserUpdateRequest request) {
    ...
    @AfterMapping
    protected void validateWeight(UserUpdateRequest request) {
    ...
    @AfterMapping
    protected void validateHeight(UserUpdateRequest request) {
